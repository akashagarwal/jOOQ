...
public class Sequences extends TableImpl<Record> {
	...
	private static final long serialVersionUID = -1241185884;
	 ...
	 */
	public static final TableField<Record, String> SEQUENCE_CATALOG = createField("SEQUENCE_CATALOG", org.jooq.impl.SQLDataType.VARCHAR.length(2147483647), SEQUENCES, "");

	/**
	 * The column <code>INFORMATION_SCHEMA.SEQUENCES.SEQUENCE_SCHEMA</code>.
	 */
	public static final TableField<Record, String> SEQUENCE_SCHEMA = createField("SEQUENCE_SCHEMA", org.jooq.impl.SQLDataType.VARCHAR.length(2147483647), SEQUENCES, "");

	/**
	 * The column <code>INFORMATION_SCHEMA.SEQUENCES.SEQUENCE_NAME</code>.
	 */
	public static final TableField<Record, String> SEQUENCE_NAME = createField("SEQUENCE_NAME", org.jooq.impl.SQLDataType.VARCHAR.length(2147483647), SEQUENCES, "");
	 ...
	 */
	public static final TableField<Record, String> REMARKS = createField("REMARKS", org.jooq.impl.SQLDataType.VARCHAR.length(2147483647), SEQUENCES, "");
