...
public class Schemata extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	private static final long serialVersionUID = 1483886468;
	...
	public Schemata(java.lang.String alias) {
		this(alias, org.jooq.util.hsqldb.information_schema.tables.Schemata.SCHEMATA);
	}
	...
	public org.jooq.util.hsqldb.information_schema.tables.Schemata as(java.lang.String alias) {
		return new org.jooq.util.hsqldb.information_schema.tables.Schemata(alias, this);
	}

	/**
	 * Rename this table.
	 */
	public org.jooq.util.hsqldb.information_schema.tables.Schemata rename(java.lang.String name) {
		return new org.jooq.util.hsqldb.information_schema.tables.Schemata(name, null);
	}
}
