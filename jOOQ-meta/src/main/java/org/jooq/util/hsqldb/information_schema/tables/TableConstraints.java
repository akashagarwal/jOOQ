...
public class TableConstraints extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	private static final long serialVersionUID = 1846850405;
	...
	public TableConstraints(java.lang.String alias) {
		this(alias, org.jooq.util.hsqldb.information_schema.tables.TableConstraints.TABLE_CONSTRAINTS);
	}
	...
	public org.jooq.util.hsqldb.information_schema.tables.TableConstraints as(java.lang.String alias) {
		return new org.jooq.util.hsqldb.information_schema.tables.TableConstraints(alias, this);
	}

	/**
	 * Rename this table.
	 */
	public org.jooq.util.hsqldb.information_schema.tables.TableConstraints rename(java.lang.String name) {
		return new org.jooq.util.hsqldb.information_schema.tables.TableConstraints(name, null);
	}
}
