...
public class CheckConstraints extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	private static final long serialVersionUID = -836721390;
	...
	public CheckConstraints(java.lang.String alias) {
		this(alias, org.jooq.util.hsqldb.information_schema.tables.CheckConstraints.CHECK_CONSTRAINTS);
	}
	...
	public org.jooq.util.hsqldb.information_schema.tables.CheckConstraints as(java.lang.String alias) {
		return new org.jooq.util.hsqldb.information_schema.tables.CheckConstraints(alias, this);
	}

	/**
	 * Rename this table.
	 */
	public org.jooq.util.hsqldb.information_schema.tables.CheckConstraints rename(java.lang.String name) {
		return new org.jooq.util.hsqldb.information_schema.tables.CheckConstraints(name, null);
	}
}
