...
public class Sequences extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	private static final long serialVersionUID = 1818124946;
	...
	public Sequences(java.lang.String alias) {
		this(alias, org.jooq.util.hsqldb.information_schema.tables.Sequences.SEQUENCES);
	}
	...
	public org.jooq.util.hsqldb.information_schema.tables.Sequences as(java.lang.String alias) {
		return new org.jooq.util.hsqldb.information_schema.tables.Sequences(alias, this);
	}

	/**
	 * Rename this table.
	 */
	public org.jooq.util.hsqldb.information_schema.tables.Sequences rename(java.lang.String name) {
		return new org.jooq.util.hsqldb.information_schema.tables.Sequences(name, null);
	}
}
